...
* Heap memory usage dropped by as much as fifty percent on average in Chrome 55 versus Chrome 53, while zone memory usage dropped 40 percent.
...
* “More optimization is in the works especially for lower-end devices with less than a gigabyte of memory,” said CNET.
* Peak zone memory improvements since Chrome 54 reduced by about 40 percent on average over the measured websites.
![img](http://media.idownloadblog.com/wp-content/uploads/2016/10/Chrome-55-memory-optimization.png)
...
* The new V8 lets it perform “more compaction work since smaller work chunks allow more work to be done in parallel by the memory compaction threads,” says Google.
