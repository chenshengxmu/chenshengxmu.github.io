...
* The credible EVLeaks tweeted out the above shot this morning.
...
* And this is what it looks like closed, without an iPhone docked.
![img](http://media.idownloadblog.com/wp-content/uploads/2013/10/MOGA-MFi-iPhone-controller-EVLeaks-003.png)
* iOS 7 supports two types of physical controllers: the form-fitting ones that dock the device itself right intro the controller and standalone variants which pair with any iOS 7 device over Bluetooth.
* The iPhone maker is understood to be closely working with accessory makers like Logitech on these controllers and being an avid gamer, I can’t wait to put my hands on one of these beauties.
