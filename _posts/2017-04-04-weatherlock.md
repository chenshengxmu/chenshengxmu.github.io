...
* After you install WeatherLock, you can enable the tweak from the preferences pane in the Settings app:
![img](http://media.idownloadblog.com/wp-content/uploads/2017/04/WeatherLock-preferences-pane.jpg)
* There’s no need to respring your device after toggling the tweak on or off since your changes happen in real time.
* For WeatherLock to work, the stock Weather app must be installed on your iPhone, which may be an issue for any of you that are using a third-party weather app from the App Store in its place. If this is the case, and you want to use WeatherLock, you need only reinstall the stock Weather app from the App Store by searching for it.
...
* Note: WeatherLock does not work with HotDog, ColorFlow, LockHTML, Falcon, re:scale, ntspeed, or some features of HideMeX.
* You might also like: This tweak puts Moon phase information in your Status Bar
