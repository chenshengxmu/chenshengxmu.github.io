...
* For instance, Photoshop users might assign shortcuts to these keys for instant access to their favorite image-editing tools. “In iMessage, they could be used to switch between conversations with your favorite contacts, or to start a new one,” the author writes.
* Imagining custom Photoshop keys on MacBook Pro’s rumored OLED bar.
![img](http://media.idownloadblog.com/wp-content/uploads/2016/05/MacBook-Pro-OLED-bar-mockup-Cult-of-Mac-001.jpg)
* “An OLED touch pad, replacing only the line of function keys, would give Apple’s next MacBook Pro the best of both worlds,“ he writes.
...
* They all have these keyboard that are there whether you need them or not to be there. And they all have these control buttons that are fixed in plastic and are the same for every application.
