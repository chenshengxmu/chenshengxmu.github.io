...
* Installing RWP Slider transforms your iPhone’s stock Control Center-based brightness slider into a multi-functional adjustment interface. With the tap of a button, the brightness slider shifts from adjusting the display’s backlight brightness to changing the display’s white point level.
* In the screenshot examples above, you’ll notice the Reduce White Point toggle to the right of the brightness slider in Control Center. You can enable this button to change the brightness slider’s function between brightness and Reduce White Point on demand.
