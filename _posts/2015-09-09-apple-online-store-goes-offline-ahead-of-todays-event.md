...
* As you have probably heard by now, Apple is expected to hold a massive presentation today to introduce new iPhones, iPads and refresh its Apple TV set-top box.
* Rumors in the run-up to the event have pointed to an always-listening ‘Hey Siri’ functionality on the iPhone 6s and iPhone 6s Plus, likely with a little help from a dedicated voice activation chip to preserve battery life.
...
* It’s been also said that the iPad Pro will start at $799 for the entry-level Wi-Fi-only model with thirty-two gigabytes of storage and go all the way up to $1,129 for the flagship Wi-Fi+Cellular model with 128 gigabytes of storage.
* What are you most excited about for Apple’s September 9 event?
* We are ready for the press conference so join us later for continual pre and post-event coverage as we’ll be making sure you stay on top of whatever new products the company unveils today.
* Source: Apple
