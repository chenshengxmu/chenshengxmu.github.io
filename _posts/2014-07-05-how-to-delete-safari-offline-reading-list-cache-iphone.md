...
* Today, I want to focus on Safari’s Reading List. Having debuted in iOS 5, this useful albeit storage-consuming feature has been around for several years now.
* If you save webpages for later to Safari’s Reading List, this tutorial will teach you how to save storage space by deleting Safari’s Offline Reading List cache.
...
* It’s a lot like Instapaper or Pocket, but built right into Safari on iOS and macOS. Adding a webpage to your Reading List allows you to view and read it later in its full glory on iCloud-connected devices (iPhones, iPads, iPods and Macs), even if you’re not connected to the Internet.
...
* Step 1: Open Settings on your iPhone, iPod touch or iPad and navigate to General > Storage & iCloud Usage, and select Manage Storage under the Storage section. Wait a little until iOS populates the list with apps. Locate Safari in the list and tap on it for more information.
![img](http://media.idownloadblog.com/wp-content/uploads/2014/07/Safari-Reading-List-clearing-cache-001.png)
![img](http://media.idownloadblog.com/wp-content/uploads/2014/07/Safari-Reading-List-clearing-cache-002.png)
...
![img](http://media.idownloadblog.com/wp-content/uploads/2014/07/Safari-Reading-List-clearing-cache-003.png)
![img](http://media.idownloadblog.com/wp-content/uploads/2014/07/Safari-Reading-List-clearing-cache-004.png)
...
![img](http://media.idownloadblog.com/wp-content/uploads/2014/07/iOS-7-Safari-Offline-Reading-List-Delete-001.png)
