...
* As pictured top of post, the sensors are the two rows of dense rectangles marked in red.
...
* iFixit notes that Active Edge feels futuristic and new.
...
* Here’s half of the pair of squeeze sensors.
![img](http://media.idownloadblog.com/wp-content/uploads/2017/10/Google-Pixel-2-XL-teardown-squeeze-sensor-iFixit-002.jpeg)
* “As you squeeze, the outer row of gauges should be shortened, while the inner row is lengthened,” notes iFixit. “This gives the Pixel software a larger absolute deflection to detect and measure to trigger the feature.”
* Pixel 2 XL includes a 13.6 Wh battery (3520 mAh at 3.85 V)—slightly more than the original Pixel’s 13.3 Wh cell, roughly on par with Samsung’s Galaxy S8 Plus (13.5 Wh) and considerably more than Apple’s iPhone 8 Plus (10.3 Wh).
* The phone includes Google’s very first in-house designed chip, dubbed Pixel Visual Core. Located next to the RAM and Qualcomm’s Snapdragon 835 processor, this chip (labeled SR3HX X726C502) will be enabled for developers starting with Android Oreo 8.1.
![img](http://media.idownloadblog.com/wp-content/uploads/2017/10/Google-Pixel-2-XL-teardown-Google-Pixel-Visual-Core-chip-iFixit-003.jpeg)
* Meet Google’s very first in-house designed chip, dubbed Pixel Visual Core.
...
* The device packs in a six-inch Plastic OLED display (very poorly received) with a display resolution of 1,440-by-2,880 pixels (538 ppi) and 3D Gorilla Glass 5 protection. It’s powered by Qualcomm’s 64-bit octa-core Snapdragon 835 chip (four speedy 2.35 GHz CPU cores + four low-power 1.9 GHz CPU cores) with 4 GB of Samsung-built LPDDR4x RAM.
![img](http://media.idownloadblog.com/wp-content/uploads/2017/10/Google-Pixel-2-XL-teardown-iFixit-002.jpeg)
* Other features include a 12.2-megapixel f/1.8 rear camera (with dual pixel phase detection autofocus and laser detection autofocus), an eight-megapixel front camera, 64 GB or 128 GB of Samsung-built flash storage, a rear-mounted fingerprint sensor, IP67-rated water and dust resistance, Android 8.0 Oreo, USB-C, no headphone jack and more.
