...
* More importantly, Android O lets you batch notifications into topic-based groups, known as channels. For instance, a messaging app could set up separate notification channels for each conversation group created by the user.
![img](http://media.idownloadblog.com/wp-content/uploads/2017/03/Android-O-notifications-inline-controls-001.png)
* All notifications in a channel behave the same.
* You can block or change the behavior of each channel individually at any time and adjust characteristics such as importance, sound, lights, vibration and whether or not the channel is shown on the Lock screen or overrides Do Not Disturb mode.
![img](http://media.idownloadblog.com/wp-content/uploads/2017/03/Android-O-teaser-001.png)
...
* Picture in picture (PiP) video modes debuted in Android TV.
...
* In an effort to maximize power performance, Android O imposes additional automatic limits on background activity, helping boost the device’s interactive performance and reduce network activity in order to improve battery life.
...
![img](http://media.idownloadblog.com/wp-content/uploads/2017/03/Android-O-adaptive-icons-animation-001.gif)
![img](http://media.idownloadblog.com/wp-content/uploads/2017/03/Android-O-adaptive-icons-animation-002.gif)
...
![img](http://media.idownloadblog.com/wp-content/uploads/2017/03/Android-O-adaptive-icons-animation-004.gif)
* Apple doesn’t support adaptive icons, but iOS 10.3 will let apps change their Home screen icon without requiring a new binary from App Store.
...
* Various platform enhancements in Android O include new APIs for autofillers, multi-processes, low-latency audio and system-level integration with VoIP apps (like on iOS 10). Google Safe Browsing is now supported across web views in apps. Android O also brings support for Wi-Fi Aware (previously known as Neighbor Awareness Networking).
...
* Arrow and tab-based keyboard navigation is now a reality. “With the advent of Google Play apps on Chrome OS and other large form factors, we’re seeing a resurgence of keyboard navigation use within apps,” said the firm.
...
* Want to download Android O’s new default wallpaper? Grab it from Imgur!
