...
* Instead, you’ll have to log in first, and then follow these steps:
* 1) Click on your account name from the Menu Bar on your Mac.
![img](http://media.idownloadblog.com/wp-content/uploads/2016/06/OS-X-Menu-Bar-Login-Window-Menu.png)
...
* 4) Enter your password to log back into your account again.
* 5) The screenshot should appear on your desktop within seconds:
![img](http://media.idownloadblog.com/wp-content/uploads/2016/06/OS-X-screenshot-of-lock-screen-on-mac.png)
...
* 1) Open the System Preferences app and then click on the Users & Groups preferences pane.
![img](http://media.idownloadblog.com/wp-content/uploads/2016/06/Users-and-Groups-Mac-System-Preferences.png)
* 2) Next, click on the Lock button at the bottom of the preferences pane to unlock your settings.
![img](http://media.idownloadblog.com/wp-content/uploads/2016/05/Make-changes-to-Mac-users-and-Groups-Settings.png)
* 3) Enter your password when prompted to allow access to these settings, then click on the blue Unlock button.
![img](http://media.idownloadblog.com/wp-content/uploads/2016/05/OS-X-System-Preferences-is-trying-to-unlock-users-groups-pefernces-type-your-password-to-allow-this.png)
* 4) Now that your settings are unlocked, you’ll want to click on the Login Options button.
![img](http://media.idownloadblog.com/wp-content/uploads/2016/06/OS-X-Users-and-Groups-Settings-Login-Options.png)
* 5) From the next preferences pane, put a check mark in the Show fast user switching menu as checkbox, and then choose how you want the menu to appear in your Mac’s Menu Bar.
![img](http://media.idownloadblog.com/wp-content/uploads/2016/06/Mac-OS-X-Show-fast-user-switching-menu-setting.png)
* 6) Now just click on the Lock button once again to lock your changes, and you should now see your own user account name in your Mac’s Menu Bar.
![img](http://media.idownloadblog.com/wp-content/uploads/2016/06/OS-X-Menu-Bar-Full-Name.png)
