...
* And if the Automatic Downloads option is enabled in the companion Apple Watch app on your iPhone, TestFlight will automatically install watchOS 2 beta apps to your wrist-worn device.
![img](http://media.idownloadblog.com/wp-content/uploads/2015/08/TestFlight-1.2-for-iOS-iPhone-screenshot-001.png)
* I use TestFlight on a daily basis for work-in-progress apps that developers share with me, so I can test important app updates and new releases before they hit the App Store.
