...
* Similar to Telltale’s other hits, Game of Thrones will be an episodic thriller, with a storyline that’s based on the decisions you make throughout. And of course it’ll be littered with interactive characters and familiar locations like King’s Landing and The Wall.
* There’s no word on when the game will become available, but given the recent ramp up in PR and promotions, it seems like it’s going to be sooner than later. Telltale is also working on another new title, Tales from the Borderlands, expected early next year.
* [via TouchArcade]
