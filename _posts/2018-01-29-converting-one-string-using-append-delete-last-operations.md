---
layout: post
title: Converting one string to other using append and delete last operations
---
...
{% endhighlight %}
* First of all we determine the common prefix of both strings and then depending upon the value of common prefix, str1.length, str2.length and k we can conclude result. Below are the cases. CASE A: Cases where we can change str1 to str2 :
