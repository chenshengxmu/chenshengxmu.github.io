---
layout: post
title: Program for credit card number validation
---
...
* Step 5. If the result from Step 4 is divisible by 10, the card number is valid; otherwise, it is invalid. Examples :
{% highlight cpp %}
