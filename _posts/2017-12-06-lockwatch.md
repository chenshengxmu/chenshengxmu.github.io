...
* As you might expect, the weather watch face depicts the weather conditions for your current location. We’ve included an example of that watch face below so you can see how it works:
![img](http://media.idownloadblog.com/wp-content/uploads/2017/12/LockWatch-Weather.jpeg)
* Just like on an Apple Watch, you can customize all of LockWatch’s watch faces:
![img](http://media.idownloadblog.com/wp-content/uploads/2017/12/LockWatch-Customize-Button.jpeg)
* If you have a 3D Touch-enabled device or use Peek-A-Boo to simulate 3D Touch, then you can use a 3D Touch gesture to invoke the menu you see above. Otherwise, you can just tap and hold on the watch face to reveal it instead.
![img](http://media.idownloadblog.com/wp-content/uploads/2017/12/LockWatch-Customize.jpg)
...
* One small tidbit that I really liked about LockWatch was its attention to detail during incoming notifications. As shown below, the watch face automatically shrinks down to provide adequate space for the banner:
![img](http://media.idownloadblog.com/wp-content/uploads/2017/12/WatchLock-Smaller-Clock.jpeg)
* You can toggle the tweak on or off in its entirety from the dedicated preference pane in the Settings app:
![img](http://media.idownloadblog.com/wp-content/uploads/2017/12/LockWatch-Prefs.jpg)
* The respring button lets you save your changes when enabling or disabling the tweak, but keep in mind, you won’t need to respring if you’re merely customizing a watch face.
