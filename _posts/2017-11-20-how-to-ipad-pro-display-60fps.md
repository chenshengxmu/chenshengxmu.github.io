...
* When you’re watching a still image or a movie, the refresh rate of the LCD panel may slow down to 24FPS, 30FPS or 48FPS to match the frame rate of most movies and avoid that annoying judder effect observable while watching 24FPS content on a 60FPS display.
![img](http://media.idownloadblog.com/wp-content/uploads/2017/06/iPad-Pro-10.5-Demo-Wallpaper-Splash.jpg)
* For everything else, it can switch to up to 120FPS.
...
* Conversely, playing a game or scrolling around in Safari will ramp up the LCD panel refresh rate to 120FPS for maximum smoothness so you can even read text that’s scrolling by quickly.
![img](http://media.idownloadblog.com/wp-content/uploads/2015/09/iPad-Pro-with-Apple-Pencil-lifestyle-004.jpg)
* The adaptive, increased frame rate improves clarity and legibility.
* Movies and videos look better, scrolling is more fluid and games play smoothly without distracting artifacts known as tearing that occur when the game is not in sync with the display’s refresh rate. Moreover, ProMotion effectively halves the latency on the Apple Pencil by reducing delay in the ink appearing on the screen as you draw.
...
* 3) Tap the Display Accommodations sub-section.
* 4) Slide the switch labeled Limit Frame Rate to the ON position.
![img](http://media.idownloadblog.com/wp-content/uploads/2017/11/iOS_11_Settings_Accessibility_Limit_Frame_Rate_enabled_iPad_Pro_001.jpg)
* TIP: This feature is available only on the 2nd gen 12.9-inch iPad Pro and the 10.5-inch iPad Pro.
* Keep in mind that this setting simply limits the number of times the iPad Pro’s screen is refreshed to 60 times per second, it does not turn off ProMotion technology completely.
...
* The battery in your iPad Pro may last longer between charges, but on the other hand Apple Pencil’s industry-leading lag time of 20ms will double to 40ms.
![img](http://media.idownloadblog.com/wp-content/uploads/2017/11/iPad-Pro-ProMotion-technology-web-screenshot-001.png)
* You may notice jittery motion while watching 24FPS movies due to the 3:2 pulldown.
