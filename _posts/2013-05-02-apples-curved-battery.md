...
![img](http://media.idownloadblog.com/wp-content/uploads/2013/05/Apple-patent-rounded-battery-drawing-002.png)
...
![img](http://media.idownloadblog.com/wp-content/uploads/2013/05/Apple-patent-rounded-battery-drawing-001.png)
* While there is no certainty the new battery designs will appear in any Apple products, the company has proposed a number of devices where such flexibility would be an advantage. Along with the much-ballyhooed iWatch, which appears to combine some iPhone technology with a wristwatch, Apple has proposed handsets with wrap-around displays.
![img](http://media.idownloadblog.com/wp-content/uploads/2013/05/Apple-patent-rounded-battery-drawing-003.png)
