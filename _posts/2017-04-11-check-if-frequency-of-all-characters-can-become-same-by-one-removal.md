---
layout: post
title: Check if frequency of all characters can become same by one removal
---
* Given a string which contains lower alphabetic characters, we need to remove at most one character from this string in such a way that frequency of each distinct character becomes same in the string. Examples:
{% highlight cpp %}
Input  : str = “xyyz”
Output : Yes
