...
* In addition to universal support, today’s Hearthstone update features several bug fixes. The release notes say the new firmware remedies an issue where cards were not awarded after Blackrock Mountain, and ‘Spectate Invite’ should now work for both sides.
* Hearthstone: Heroes of Warcraft originally launched for iPad in April of last year. For those who haven’t played the game, you collect strategy cards featuring characters and elements from the Warcraft universe, and then use them in 1-on-1 battles against others.
* Hearthstone is free-to-play, but note that it has tons of IAP offerings, and it’s available in the App Store here.
